...
import { ArrowRight, Mail, Lock, User, Eye, EyeOff, CheckCircle, ArrowLeft } from 'lucide-react';
// import { GoogleLogin } from '@react-oauth/google';
import { UserContext } from "../state_management/UserContext";
import apiService from "../utils/api";
import OTPInput from "./OTPInput";
import { RegisterData, OTPData, ApiResponse } from "../types";
...
const Register = () => {
  ...
  let [response, setResponse] = useState<ApiResponse>({ message: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.message === 'OTP sent to your email for verification') {
        setShowOTPInput(true);
        setPendingUser(registerData);
        localStorage.setItem('pendingUser', JSON.stringify(registerData));
      } else {
  ...
  const handleOTPVerification = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.message === 'Email verified successfully! Welcome to FlashFire Dashboard') {
