...
type ModalSection = "personal" | "education" | "professional" | "preferences" | "links" | "terms"
...
function Header({ stepIndex }: { stepIndex: number }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-t-2xl">
      <div className="bg-gradient-to-r from-orange-500 via-orange-600 to-red-600 p-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            <p className="uppercase tracking-widest text-xs font-semibold text-white/90 mb-2">
              FlashFire — Client Onboarding
            </p>
...
async function uploadFileLocally(file: File, fileType: "resume" | "coverLetter") {
  ...
  if (!API_BASE_URL) {
    throw new Error("Missing VITE_API_BASE_URL. Add it in your .env file.")
  }
  ...
  return (
    <div>
      ...
      <div className="relative">
        <input
          type="file"
          className="block w-full cursor-pointer rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-6 text-sm file:mr-4 file:rounded-md file:border-0 file:bg-orange-600 file:px-4 file:py-2 file:text-white hover:file:bg-orange-700 transition-all duration-200 hover:border-gray-400 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20"
...
export default function NewUserModal({
  ...
  const arrToLine = (v: any) => (Array.isArray(v) ? v.join("; ") : typeof v === "string" ? v : "")
  ...
  const submitForm = async () => {
    try {
      ...
      if (!API_BASE_URL) {
        throw new Error(JSON.stringify({ message: "Missing VITE_API_BASE_URL. Add it in your .env file." }))
      }
      ...
      console.log('localStorage userAuth:', localStorage.getItem("userAuth"))
      ...
      const payloadFromApi = resJson?.userProfile ?? resJson?.data?.userProfile ?? resJson?.data ?? resJson
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div className="sm:col-span-2">
                    ...
                    <TextInput
                      ...
                      onChange={(e) => set({ bachelorsUniDegree: e.target.value })}
                    />
                  ...
                  <div>
                    ...
                    <TextInput
                      type="month"
                      placeholder="Select graduation month and year"
                      value={data.bachelorsGradMonthYear}
                      onChange={(e) => set({ bachelorsGradMonthYear: e.target.value })}
                    />
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div className="sm:col-span-2">
                    ...
                    <TextInput
                      placeholder="Enter your master's degree details"
                      value={data.mastersUniDegree}
                      onChange={(e) => set({ mastersUniDegree: e.target.value })}
                    />
                  ...
                  <div>
                    ...
                    <TextInput
                      ...
                      onChange={(e) => set({ mastersGradMonthYear: e.target.value })}
                    />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  ...
                  <TextInput
                    placeholder="Enter your preferred job roles"
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) => set({ expectedSalaryRange: e.target.value })}
                  >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  ...
                  <TextInput
                    placeholder="Enter your preferred job locations"
                ...
                <div className="sm:col-span-2">
                  ...
                  <TextInput
                    placeholder="Enter companies you want to work for"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                  ...
                  {data.ssnNumber && data.ssnNumber.length > 0 && data.ssnNumber.length !== 9 && (
                    <p className="mt-2 text-sm text-amber-600 font-medium">
                      SSN must be exactly 9 digits or left empty
                    </p>
                  )}
                ...
                <div className="sm:col-span-2">
                  ...
                  <TextArea
                    rows={3}
                    placeholder="Explain why you left your previous role"
              ...
              <div className="space-y-4 rounded-xl border border-gray-200 bg-gray-50 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <label htmlFor="confirm" className="text-sm text-gray-800 leading-relaxed">
                    I confirm that the information provided is accurate and can be used for job applications on my
                    behalf.
                ...
                <div className="flex items-start gap-4">
                  ...
                  <label htmlFor="tos" className="text-sm text-gray-800 leading-relaxed">
                    ...
                    <a
                      className="ml-1 underline decoration-orange-600 decoration-2 underline-offset-2 hover:text-orange-600"
                      href="https://www.flashfirejobs.com/termsofservice"
                      target="_blank"
                      rel="noreferrer"
                    >
        ...
        <div className="flex items-center justify-between gap-4 border-t border-gray-200 bg-gray-50 px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            {!isLast ? (
              <button
                onClick={next}
                className="inline-flex items-center rounded-lg bg-orange-600 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-700 transition-colors duration-200"
              >
                Next
              </button>
            ) : (
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[60]">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
        <div className="text-center">
          ...
          {/* Success Message */}
          <h3 className="text-2xl font-bold text-gray-900 mb-3">Profile Completed Successfully!</h3>

          <p className="text-gray-600 mb-8 text-base leading-relaxed">
            Your profile has been saved and you can now access the dashboard. We'll use this information to help you
          ...
          <button
            onClick={onClose}
            className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 shadow-sm"
          >
