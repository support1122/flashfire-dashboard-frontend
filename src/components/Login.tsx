    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-[480px] xl:w-[520px] flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-10 bg-gray-100 min-h-screen lg:min-h-0">
        ...
        <div className="w-full mb-6" id="google-button-wrapper">
          <style>{`
            /* Google's own button, shown as-is. It used to be rendered at
               opacity:0 beneath a look-alike button so we could style it
               freely, but GSI refuses to start the sign-in flow for a button
               it considers hidden - an anti-clickjacking guard - so clicking
               did nothing in production. Verified on the deployed site: the
               same click opened the Google popup as soon as the real button
               was made visible.

               All that is left to do is stretch it, since Google hard-caps
               its widget at 400px. Matched by id and role="button" rather
               than its generated class names, which change without notice. */
